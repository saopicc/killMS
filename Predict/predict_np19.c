...
static PyObject *predict(PyObject *self, PyObject *args)
{
  ...
  PyArrayObject *Np_l;
  Np_l = (PyArrayObject *) PyArray_ContiguousFromObject(PyList_GetItem(LSM, 0), NPY_FLOAT32, 0, 4);
  PyArrayObject *Np_m;
  Np_m = (PyArrayObject *) PyArray_ContiguousFromObject(PyList_GetItem(LSM, 1), NPY_FLOAT32, 0, 4);
  PyArrayObject *Np_I;
  Np_I = (PyArrayObject *) PyArray_ContiguousFromObject(PyList_GetItem(LSM, 2), NPY_FLOAT32, 0, 4);
  ...
  NpWaveL= (PyArrayObject *) PyArray_ContiguousFromObject(LFreq0, NPY_FLOAT32, 0, 4);
  PyArrayObject *NpFreqs;
  NpFreqs= (PyArrayObject *) PyArray_ContiguousFromObject(LFreq1, NPY_FLOAT32, 0, 4);
  PyArrayObject *NpDFreqs;
  NpDFreqs= (PyArrayObject *) PyArray_ContiguousFromObject(LFreq2, NPY_FLOAT32, 0, 4);
  ...
  NpUVW_dt= (PyArrayObject *) PyArray_ContiguousFromObject(PyList_GetItem(LUVWSpeed, 0), NPY_FLOAT32, 0, 4);
  //PyArrayObject *NpDFreqs;
