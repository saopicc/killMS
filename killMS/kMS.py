...
def read_options():
    ...
    OP.add_option("ApplyPJones",type="int",default=0,help='derotate visibility data (only when FITS beam is active and also time sampled)')
    OP.add_option("FlipVisibilityHands",type="int",default=0,help='apply anti-diagonal matrix if FITS beam is enabled effectively swapping X and Y or R and L and their respective hands')
    OP.add_option("FeedAngle",type="float",default=0,help='offset feed angle to add to parallactic angle')
